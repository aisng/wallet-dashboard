class Api::V1::DashboardController < ApplicationController
  ...
  param :dashboard, Hash, required: true do
    ...
    param :testnet, :bool, required: true, desc: 'Flag to indicate if the testnet is used', allow_blank: true
    ...
    param :block_tag, String, required: false, desc: 'Block tag (e.g. latest, pending) or block number in decimal'
    param :block_number, String, required: false, desc: 'Block number in decimal (e.g. 12345)', allow_blank: true
